...
fun InkHomeSlotPickerScreen(
    ...
    Column(
        ...
        InkText(
            text = stringResource(R.string.settings_home_slot_picker_title, slotIndex + 1),
            style = text.greeting,
            modifier = Modifier.padding(top = 20.dp, bottom = 8.dp),
        )
        InkText(
            text = stringResource(R.string.settings_home_slot_clear),
            style = text.notificationEmpty,
            modifier = Modifier
                .padding(bottom = 12.dp)
                .inkClickable(onClick = onClearSlot),
        )
        InkSearchField(
            value = query,
